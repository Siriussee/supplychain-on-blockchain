...
var SupplyChainToken = artifacts.require('SupplyChainToken')
var InvoiceToken = artifacts.require('InvoiceToken')
const truffleAssert = require('truffle-assertions')

contract('SupplyChain', function(accounts) {
    let supplyChainToken;
    let invoiceToken;
    let supplyChain;
    ...
    const transferToSaleContract = web3.utils.toWei(new web3.utils.BN(tokenTotalSupply)).div(new web3.utils.BN(2));
    ...
    before(async () => {
        //supplyChainToken = await SupplyChainToken.new('SupplyChainToken', 'SCT', tokenTotalSupply, {from: ownerID});
        //supplyChain = await SupplyChain.new(supplyChainToken.address, '1', {from: ownerID});
        //let randownvar = await supplyChain.transfer(supplyChainToken.address, transferToSaleContract, {from: ownerID});
    });
    ...
    describe('Test business process function of supply chain', async()=>{
        before(async () => {
            ...
            let randownvar = await supplyChainToken.transfer(supplyChain.address, transferToSaleContract, {from: ownerID});
        });
        ...
        it("Testing buyToken() that top-up balance", async()=>{
            ...
            assert.equal(balanceAfter, 100, 'Error: SCT is not 100.')
    ...
    describe('Test business process function of supply chain', async()=>{
        ...
        it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
            ...
            const _price = parseInt("1000") //1/10000 Ether or 1e12 Wei
        ...
        it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
            ...
            await truffleAssert.fails(
                supplyChain.buyItem(upc, invoiceId, {from: distributorID}), //SCT[distributorID] = 100,
                truffleAssert.ErrorType.REVERT
            );
            ...
            let tx = await supplyChain.buyItem(upc, invoiceId, {from: distributorID}) //SCT[distributorID] = 1100
        ...
        it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
            ...
            let randomvar = await supplyChain.addFarmer(originFarmerID);
        ...
        it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
            ...
            let buytoken = await supplyChain.buyTokens(1000, {from: retailerID, value: 1000})
        ...
        it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
            ...
            let buytoken = await supplyChain.buyTokens(1000, {from: consumerID, value: 1000})

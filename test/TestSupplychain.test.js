...
contract('SupplyChain', function(accounts) {
	...
	it("0. Testing smart contract function owner()/isOwner()/renounceOwnership()/transferOwnership() that modify contract's owner", async() => {
	...
	it("1. Testing smart contract function addFarmer()/renounceFarmer() that adds/removes a farmer to/from supply chain", async() => {
		const supplyChain = await SupplyChain.deployed()
	...
	it("2. Testing smart contract function addDistributor()/renounceDistributor() that adds/removes a Distributor to/from supply chain", async() => {
		const supplyChain = await SupplyChain.deployed()
	...
	it("3. Testing smart contract function addConsumer()/renounceConsumer() that adds/removes a Consumer to/from supply chain", async() => {
		const supplyChain = await SupplyChain.deployed()
	...
	it("4. Testing smart contract function addRetailer()/renounceRetailer() that adds/removes a Retailer to/from supply chain", async() => {
		const supplyChain = await SupplyChain.deployed()
